...
This project is indexed by GitNexus as **OpenExecutive** (15968 symbols, 41059 relationships, 748 execution flows).
...
| Resource | Use for |
| --- | --- |
| `gitnexus://repo/OpenExecutive/context` | Codebase overview, check index freshness |
| `gitnexus://repo/OpenExecutive/clusters` | All functional areas |
| `gitnexus://repo/OpenExecutive/processes` | All execution flows |
| `gitnexus://repo/OpenExecutive/process/{name}` | Step-by-step execution trace |
